...
final class SignupViewControllersTests: XCTestCase {
    ...
    func testSignupViewController_WhenCreated_HasRequiredTextFieldsEmpty() throws {
        ...
        XCTAssertEqual(firstNameTextField.text, "",
                       "First name text field was not empty then the view controller initially loaded")
        XCTAssertEqual(lastNameTextField.text, "",
                       "Last name text field was not empty then the view controller initially loaded")
        XCTAssertEqual(emailTextField.text, "",
                       "Email text field was not empty then the view controller initially loaded")
        XCTAssertEqual(passwordTextField.text, "",
                       "Password text field was not empty then the view controller initially loaded")
        XCTAssertEqual(repeatPasswordTextField.text, "",
                       "Repeat Password text field was not empty then the view controller initially loaded")
    }
